  ...
  return (
    <div className='container'>
      ...
      <div className='filters'>
        <div onClick={() => handleSelection('couples')}>couples</div>
        <div onClick={() => handleSelection('wallpapers')}>wallpapers</div>
        <div onClick={() => handleSelection('velentine')}>velentine</div>
        <div onClick={() => handleSelection('book')}>book</div>
        ...
        <div onClick={() => handleSelection('film')}>film</div>
        <div onClick={() => handleSelection('nature')}>Nature</div>
